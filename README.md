...
<body>
  ...
  <hr> 
  <h2>Jesús Alberto Ferrer </h2>
  <h2>Cédula : 32.819.239</h2>
  <h2>Email : Jesusferrer328@gmail.com</h2>
  <hr>
  <h1>Datos Académicos</h1>
  <ul>
    <li>Primaria: Colegio Salto Angel</li>
    <li>Secundaria: U.E.F Francisco de Paula Salazar Acosta</li>
  </ul>
    <hr>
